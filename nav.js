// ===== Dropdown toggles — معرفين أول حاجة =====
...
function closeAllDropdowns() {
  ['contracts-dropdown', 'cs-dropdown'].forEach(function(id) {
...
function injectNavbar() {
  ...
  var navContent =
    ...
    '<nav class="nav-links">' +
      ...
      // ===== Dropdown: خدمة العملاء =====
      '<div style="position:relative;display:flex;align-items:center;">' +
        '<a href="#" onclick="toggleCSDropdown(event)" style="' +
