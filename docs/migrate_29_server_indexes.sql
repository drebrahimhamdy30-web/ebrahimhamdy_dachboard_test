...
--  ⛔ تصحيح لاحق (2026-09-19): أسماء الفهارس اللي اتمسحت هنا كانت
--     **هي المطابقة للبرودكشن**، والقراءة اللي بنينا عليها كانت غلط.
--     الأثر العملي صفر (الفهرسين كانوا نسخة طبق الأصل) — والتصحيح
--     بإعادة التسمية في migrate_32.
-- ═══════════════════════════════════════════════════════════════════
